...
TODOs:
 ...
 - change prints to logging statements
...
@_track_function_call
def inspect(user: str, dataflow: str, version: str = "latest") -> dict:
...
def list_dataflows(commit_ish: str = "latest", user: str = None):
    """Lists dataflows available based on commit_ish and user.
...
def find(query: str, commit_ish: str = None, user: str = None):
    """Searches for dataflows based on a query string.
    :param query:
    :param commit_ish:
    :param user:
    :return:
...
if __name__ == "__main__":
    ...
    _user = "zilto"
    _version = "user_contrib"
    _dataflow = "text_summarization"
    _module = import_module(_dataflow, _user, _version)
